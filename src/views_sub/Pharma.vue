<template>
  <div>
    ...
    <div class="page_container">
      <div class="content_container" id="ow_pharma" ref="ow_pharma">
        <v-container>
          ...
          <v-row class="board">
            ...
            <v-col cols="9">
              <p>
                ...
                적용하고 있습니다.<br class="pc_only" />
                <span class="ff_m">QbD</span>는 과학적인 기반 기술을 바탕으로
                의약품 품질 고도화를 목표로 하는 시스템입니다. 물질의 특성과
                여러 변수를 연계시키는<br class="pc_only" />
                연구를 통해 제품의 특성을 체계적으로 이해하고 품질을 향상시키는
                의약품을 만들기 위해 노력하고 있습니다.
              </p>
            </v-col>
          </v-row>
          <v-row class="board">
          ...
          <v-row class="board">
            <v-col>
              <v-lazy>
                <v-sheet color="white" id="ow_sparkline">
                  <v-sparkline
                    :value="value"
                    :gradient="gradient"
                    :smooth="radius || false"
          ...
          <!-- <v-row class="img_box">
            <v-col cols="12" md="6">
              <p>
                ...
                commodo ligula eget dolor. Aenean massa <b>strong</b>. Cum
          ...
          <!-- <p>
            ...
            dictum felis eu pede <a href="javascript:void 0">link</a> mollis
          ...
          <v-row class="board">
            <v-col cols="3">
              <h3>핵심<br class="pc_only" />연구 성장</h3>
            </v-col>
            <v-col cols="9">
              <p>
                <span class="ff_m">R&amp;D</span>는 제약기업의 경쟁력의 원천이자
