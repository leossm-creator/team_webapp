                            ...
                            <ul style="padding: 0 !important">
                              ...
                              <li class="list">
                                ...
                                <p class="txt">
                                  ...
                                  『동의함』 버튼 또는 『동의 안 함』 버튼을
                                  클릭할 수 있는 절차를 마련하고 있으며, 귀하가
                                  『동의 함』 버튼을 클릭하면 개인 정보 수집에
                                  대해 동의한 것으로 봅니다.
                                  <br />
                                  [이용목적] : 문의내용 답변 목적
                                </p>
                        ...
                        <v-row>
                          <v-col>
                            <v-textarea
                              ...
                              :rules="[
                                (v) => !!v || 'Please fill in your message',
                              ]"
                              required
                              rows="12"
                            ></v-textarea>
